...
<?php
        ...
        <div class="votes_stars">
            ...
            <div class="votes_vote" itemprop="rating" itemscope itemtype="http://data-vocabulary.org/Rating">
            ...
            <div class="votes_results">
                <span style="float:left; padding-bottom: 5px;"><b><?php _e('Rated:', 'voting');?>  </span>
                <?php
                    $avg_vote = $vote['vote'];
                    if($avg_vote==5) {
                ...
                <span style="display:none" itemprop="average"><?php echo $avg_vote; ?></span>
                <span style="display:none" itemprop="best">5</span>
                
                <span style="float:left; padding-right: 4px; padding-left: 4px;"><?php echo "from <span itemprop=\"votes\">". $vote['total'] ."</span>"; ?> <?php _e('votes', 'voting');?></span>
            </div>
        </div>