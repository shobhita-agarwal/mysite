...
<div id="header" <?php if(osc_is_home_page()){ ?> class="headerhomepage" <?php } ?> >
<div class="headertop">
    <!-- header ad 728x60-->
	...
	<div <?php if(osc_is_home_page()){ ?> class="headerbottom" <?php } ?>>
    <?php if( 1/*osc_is_home_page() || osc_is_static_page() || osc_is_contact_page()*/ ) { ?>
        ...
        <div class="main-search">
            ...
            <?php  if ( osc_count_categories() ) { ?>
                <div class="cell selector">
                    <?php osc_categories_select('sCategory', null, __('Select a game', 'bender')) ; ?>
                </div>
